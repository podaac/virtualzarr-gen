#!/usr/bin/env python3
"""
Append granules to the SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6 Icechunk v2 store on S3.

Usage:
    python append_SMAP_SSS.py \
...
COLLECTION = "SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6"
DEFAULT_STORE_PREFIX = "virtual_collections/SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6/SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6_icechunk_v2.s3/"
CONCAT_DIM = "time"
DATA_VARS = [
