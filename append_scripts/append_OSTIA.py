#!/usr/bin/env python3
"""
Append granules to the OSTIA-UKMO-L4-GLOB-REP-v2.0 Icechunk v2 store on S3.

Usage:
    python append_OSTIA.py \\
...
COLLECTION = "OSTIA-UKMO-L4-GLOB-REP-v2.0"
DEFAULT_STORE_PREFIX = "virtual_collections/OSTIA-UKMO-L4-GLOB-REP-v2.0/OSTIA-UKMO-L4-GLOB-REP-v2.0_icechunk_v2.s3/"
CONCAT_DIM = "time"
DATA_VARS = "minimal"
COORDS = "minimal"
