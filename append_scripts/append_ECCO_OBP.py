#!/usr/bin/env python3
"""
Append granules to the ECCO_L4_OBP_05DEG_DAILY_V4R4B Icechunk v2 store on S3.

Usage:
    python append_ECCO_OBP.py \\
...
COLLECTION = "ECCO_L4_OBP_05DEG_DAILY_V4R4B"
DEFAULT_STORE_PREFIX = "virtual_collections/ECCO_L4_OBP_05DEG_DAILY_V4R4B/ECCO_L4_OBP_05DEG_DAILY_V4R4B_icechunk_v2.s3/"
CONCAT_DIM = "time"
DATA_VARS = "minimal"
COORDS = "minimal"
