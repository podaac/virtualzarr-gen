#!/usr/bin/env python3
"""
Append granules to the ECCO_L4_TEMP_SALINITY_05DEG_DAILY_V4R4 Icechunk v2 store on S3.

Usage:
    python append_ECCO_TEMP_SALINITY.py \
...
DEFAULT_STORE_PREFIX = "virtual_collections/ECCO_L4_TEMP_SALINITY_05DEG_DAILY_V4R4/ECCO_L4_TEMP_SALINITY_05DEG_DAILY_V4R4_icechunk_v2.s3/"
CONCAT_DIM = "time"
DATA_VARS = "minimal"
COORDS = "minimal"
