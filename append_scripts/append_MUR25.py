#!/usr/bin/env python3
"""
Append granules to the MUR25-JPL-L4-GLOB-v04.2 Icechunk v2 store on S3.

Usage:
    python append_MUR25.py \\
...
DEFAULT_STORE_PREFIX = "virtual_collections/MUR25-JPL-L4-GLOB-v04.2/MUR25-JPL-L4-GLOB-v04.2_icechunk_v2.s3/"
CONCAT_DIM = "time"
DATA_VARS = "minimal"
COORDS = "minimal"
