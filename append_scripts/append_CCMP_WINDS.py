#!/usr/bin/env python3
"""
Append granules to the CCMP_WINDS_10M6HR_L4_V3.1 Icechunk v2 store on S3.

Usage:
    python append_CCMP_WINDS.py \\
...
DEFAULT_STORE_PREFIX = "virtual_collections/CCMP_WINDS_10M6HR_L4_V3.1/CCMP_WINDS_10M6HR_L4_V3.1_icechunk_v2.s3/"
CONCAT_DIM = "time"
DATA_VARS = "minimal"
COORDS = "minimal"
