#!/usr/bin/env python3
"""
Append granules to the ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4 Icechunk v2 store on S3.

Usage:
    python append_ECCO_OCEAN_VEL.py \\
...
COLLECTION = "ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4"
DEFAULT_STORE_PREFIX = "virtual_collections/ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4/ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4_icechunk_v2.s3/"
CONCAT_DIM = "time"
DATA_VARS = "minimal"
COORDS = "minimal"
