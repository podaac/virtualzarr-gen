"""
Create Icechunk v2 virtual Zarr store for the CCMP_WINDS_10M6HR_L4_V3.1 dataset.
...
SHORTNAMES = ["CCMP_WINDS_10M6HR_L4_V3.1"]

FNAME_STORE_S3 = "CCMP_WINDS_10M6HR_L4_V3.1.icechunk_v2.s3"
FNAME_STORE_HTTP = "CCMP_WINDS_10M6HR_L4_V3.1.icechunk_v2.https"
...
def main(output_bucket: str):
    ...
    vds_composite_s3.attrs['history'] = "Icechunk v2 VDS for CCMP Winds"
...
def cli():
    parser = argparse.ArgumentParser(description="Generate Icechunk v2 stores for CCMP_WINDS_10M6HR_L4_V3.1")
