"""
Create Icechunk v2 virtual Zarr store for the ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4 dataset.
...
SHORTNAMES = ["ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4"]

FNAME_STORE_S3 = "ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4.icechunk_v2.s3"
FNAME_STORE_HTTP = "ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4.icechunk_v2.https"
...
def main(output_bucket: str):
    ...
    vds_composite_s3.attrs['history'] = "Icechunk v2 VDS for ECCO L4 Ocean Velocity"
...
def cli():
    parser = argparse.ArgumentParser(description="Generate Icechunk v2 stores for ECCO_L4_OCEAN_VEL_05DEG_DAILY_V4R4")
