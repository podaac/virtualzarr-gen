"""
Create Icechunk v2 virtual Zarr store for the MUR25-JPL-L4-GLOB-v04.2 dataset.
...
FNAME_STORE_S3 = "MUR25-JPL-L4-GLOB-v04.2.icechunk_v2.s3"
FNAME_STORE_HTTP = "MUR25-JPL-L4-GLOB-v04.2.icechunk_v2.https"
...
def main(output_bucket: str):
    ...
    vds_composite_s3.attrs['identifier_product_doi'] = "https://doi.org/10.5067/GHM25-4FJ42"
    vds_composite_s3.attrs['date_created'] = "2026-09-03T00:00:00Z"
    vds_composite_s3.attrs['history'] = "Icechunk v2 VDS for MUR25"
...
def cli():
    parser = argparse.ArgumentParser(description="Generate Icechunk v2 stores for MUR25-JPL-L4-GLOB-v04.2")
    parser.add_argument(
        "--output-bucket",
        type=str,
