"""
Create Icechunk v2 virtual Zarr store for the ECCO_L4_OBP_05DEG_DAILY_V4R4B dataset.
...
SHORTNAMES = ["ECCO_L4_OBP_05DEG_DAILY_V4R4B"]

FNAME_STORE_S3 = "ECCO_L4_OBP_05DEG_DAILY_V4R4B.icechunk_v2.s3"
FNAME_STORE_HTTP = "ECCO_L4_OBP_05DEG_DAILY_V4R4B.icechunk_v2.https"
...
def main(output_bucket: str):
    ...
    vds_composite_s3.attrs['history'] = "Icechunk v2 VDS for ECCO L4 OBP"
...
def cli():
    parser = argparse.ArgumentParser(description="Generate Icechunk v2 stores for ECCO_L4_OBP_05DEG_DAILY_V4R4B")
