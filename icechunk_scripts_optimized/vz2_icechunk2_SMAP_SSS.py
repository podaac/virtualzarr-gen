"""
Create Icechunk v2 virtual Zarr store for the SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6 dataset.
...
SHORTNAMES = ["SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6"]

FNAME_STORE_S3 = "SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6.icechunk_v2.s3"
FNAME_STORE_HTTP = "SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6.icechunk_v2.https"
...
def main(output_bucket: str):
    ...
    for sn in SHORTNAMES:
        ...
        with warnings.catch_warnings():
            ...
            vds_s3 = open_virtual_mfdataset_batched(
                ...
                combine="nested",
                concat_dim="time",
                preprocess=lambda ds: ds.expand_dims("time") if "time" not in ds.dims else ds,
                data_vars=CONCAT_DATA_VARS,
                coords="minimal",
                compat="override",
                combine_attrs="override",
    ...
    vds_composite_s3.attrs['history'] = "Icechunk v2 VDS for SMAP RSS L3 SSS"
...
def cli():
    parser = argparse.ArgumentParser(description="Generate Icechunk v2 stores for SMAP_RSS_L3_SSS_SMI_8DAY-RUNNINGMEAN_V6")
    parser.add_argument(
        "--output-bucket",
        type=str,
